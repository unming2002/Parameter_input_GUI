...
public:
    ...
    {
        CEditor->setWindowTitle(QApplication::translate("CEditor", "Property Editor", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("CEditor", "Project Setting", Q_NULLPTR));
    } // retranslateUi
